...
class compress(object):
	...
	def compress_network(self, model_name):
		...
		L1 = comp_net.form_and_compress_tree(w1l, 17, frequencies)
		...
		L2 = comp_net.form_and_compress_tree(w2l, 17, frequencies)
		...
		L3 = comp_net.form_and_compress_tree(w3l, 17, frequencies)
		...
		L4 = comp_net.form_and_compress_tree(w4l, 17, frequencies)
