...
class compress(object):
	...
	def compress_network(self, model_name):
		...
		#self.scalar_node_w1 = scalarNode(w1.shape[1],-1,0,w1.shape[1],0)
		#self.node_w2 = Node(w2.shape[1],65,-1)
		#self.scalar_node_w2 = scalarNode(w2.shape[1],-1,0,w2.shape[1],0)
		#self.node_w3 = Node(w3.shape[1],65,-1)
		#self.scalar_node_w3 = scalarNode(w3.shape[1],-1,0,w3.shape[1],0)
		#self.node_w4 = Node(w4.shape[1],65,-1)
		#self.scalar_node_w4 = scalarNode(w4.shape[1],-1,0,w4.shape[1],0)
		#self.node_w5 = Node(w5.shape[1],65,-1)
		#self.scalar_node_w5 = scalarNode(w5.shape[1],-1,0,w5.shape[1],0)
		comp_net = Compressor()
