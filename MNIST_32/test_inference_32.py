...
import numpy as np
from compressor_32 import compress as comp
from inference_32 import DNNInference as di
import time
class inference(object):
	...
	def compressed_inference(self, model_name):
		...
		start_time = time.time()
		for i in range(1):    			#increase the range for exact performance, this is just for a quick check
